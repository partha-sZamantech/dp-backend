...
@section('title', 'Bn Video Position Edit')
...
<!-- Content Header (Page header) -->
    <section class="content-header">
      <ol class="breadcrumb">
        ...
        <li class="active">Bn Video Position</li>
      </ol>
    </section>
    ...
    <section class="content">
        <div class="row">
            <form action="{{ route('bn-video-position.update', $position->position_id) }}" method="post" class="form-horizontal" enctype="multipart/form-data">
                {{ csrf_field() }}
                {{ method_field('PUT') }}
                <div class="col-sm-12">
