    ...
    <script>
        ...
        function saveData(posId) {
            ...
            if(data.length == 0){
                ...
                var id = posId;
                $.post('{{ url("backend/en-position/change") }}', {'_token': '{{ csrf_token() }}', "data": data, "settings": settings, 'id': id}, function(d){
            ...
            $('#positionName').change(function() {
                ...
                $.get('{{ url("backend/en-populate-position") }}', {'position': position}, function (data) {
                    ...
                    /*if (data.position.position_id == 2) {
                        console.log('dd', data.position.position_id, data.settings.show_special)
