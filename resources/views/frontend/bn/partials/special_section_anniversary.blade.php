...
<div class="special-section marginTop15" style="padding-top: 0; position: relative; overflow: hidden;">
    ...
    <div class="container">
        <div class="special-box special-event-section">
            <a href="https://www.dhakaprokash24.com/topic/প্রথম-বর্ষপূর্তি-ঢাকা-প্রকাশ" target="_blank" rel="nofollow">
                <div class="special-event-title marginTop20">
                    <div class="desktop-image">
                        <img src="{{ asset('media/common/Page-Banner.png') }}" alt="ঢাকা প্রকাশের প্রথম বর্ষপূর্তি">
                    </div>
                    <div class="mobile-image">
                        <img src="{{ asset('media/common/Page-Banner_Mobile.png') }}" alt="ঢাকা প্রকাশের প্রথম বর্ষপূর্তি">
                    </div>
                </div>
            </a>
