...
@section('content')
    ...
    <section class="content">
        ...
        <div class="row">
            <!-- form start -->
            <form action="{{ route('bn-contents.update', $content->content_id) }}" method="post"
                    ...
                    <div class="box box-info">
                        ...
                        <div class="box-body">
                            <div class="form-group">
                                ...
                                <input type="text" name="newsHeading" value="{{ $content->content_heading }}"
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="newsSubheading" class="form-control" id="newsSubheading"
                                       placeholder="News Subheading" value="{{ $content->content_sub_heading }}">
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="metaKeywords" id="metaKeywords" class="form-control"
                                          placeholder="Comma separated meta keywords">{{ $content->meta_keywords }}</textarea>
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="briefNews" id="briefNews" class="form-control" rows="4"
                                          placeholder="Meta Description / Brief News">{{ $content->content_brief }}</textarea>
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="detailsNews" id="detailsNews" class="form-control textarea" rows="10"
                                          placeholder="Details News">{{ $content->content_details }}</textarea>
                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        <div class="box box-success text-center">
                                            ...
                                            @endif
                                            <img
                                                src="{{ asset(config('appconfig.contentImagePath').$content->img_bg_path) }}"
                                            ...
                                            <div class="row">
                                                <div class="col-sm-12">
                                                    <input type="text" name="ImageBGCaption" class="form-control"
                                                           ...
                                                           value="{{ $content->img_bg_caption ?? old('ImageBGCaption') }}"
                    ...
                    <div class="box box-info">
                        <div class="box-body form-horizontal">
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <select name="contentType" class="form-control" id="contentType">
                                        ...
                                        <option value="2" {{ $content->content_type == 2? 'selected':'' }}>Article
                                        </option>
                                    </select>
                                </div>
                            </div>
                                ...
                                <div class="col-sm-9">
                                    <select name="category" class="form-control" id="category">
                                        @foreach($categories as $category)
                                            <option
                                                value="{{ $category->cat_id }}" {{ $content->cat_id == $category->cat_id? 'selected' : '' }}>{{ $category->cat_name_bn }}</option>
                                        @endforeach
                                    </select>
                                </div>
                                ...
                                <div class="col-sm-9">
                                    <select name="specialCategory" id="specialCategory" class="form-control">
                                        ...
                                        @foreach($specialCategories as $specialCategory)
                                            <option
                                                value="{{ $specialCategory->cat_id }}" {{ $content->special_cat_id == $specialCategory->cat_id ? 'selected' : '' }}>{{ $specialCategory->cat_name_bn }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                                ...
                                <div class="col-sm-9">
                                    <select name="country" id="country" class="form-control">
                                        @foreach($countries as $country)
                                            <option
                                                value="{{ $country->country_id }}" {{ $country->country_id == $content->country_id ? 'selected' : '' }}>{{ $country->country_name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                                ...
                                <div class="col-sm-9">
                                    <select name="district" id="district" class="form-control">
                                        @foreach($districts as $district)
                                            <option
                                                value="{{ $district->district_id }}" {{ $content->district_id == $district->district_id ? 'selected' : '' }}>{{ $district->district_name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                                ...
                                <div class="col-sm-9">
                                    <select name="writer" id="writer" class="form-control">
                                        @foreach($authors as $author)
                                            <option value="{{ $author->author_slug }}" {{ $content->author_slugs == $author->author_slug ? 'selected' : '' }}>{{ $author->author_name_bn }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>--}}
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" name="authorName" class="form-control"
                                           value="{{ $content->author_name ?? old('authorName') }}"">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <select name="videoType" id="videoType" class="form-control">
                                        ...
                                        <option value="1" {{ $content->video_type == 1 ? 'selected' : '' }}>Youtube
                                        </option>
                                        <option value="2" {{ $content->video_type == 2 ? 'selected' : '' }}>Facebook
                                        </option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" id="videoId" name="videoId" value="{{ $content->video_id }}"
                                           class="form-control">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <div class="btn-group radioBtn">
                                        <a class="btn btn-primary btn-sm {{ $content->status == 1 ? 'active' : 'notActive' }}"
                                           data-toggle="status" data-title="1">Yes</a>
                                        <a class="btn btn-primary btn-sm {{ $content->status == 2 ? 'active' : 'notActive' }}"
...
{{--                                    <div class="box box-success text-center">--}}
{{--                                        <h3>Small Image</h3>--}}
{{--                                        <div class="text-danger" style="margin-bottom: 5px;">Dimension: 120 X 80 pixel &--}}
{{--                                            Max size: 10kb--}}
{{--                                        </div>--}}

{{--                                        @if($errors->has('exSmallImage'))--}}
{{--                                            <span class="text-danger">{{ $errors->first('exSmallImage') }}</span>--}}
{{--                                        @endif--}}
{{--                                        <img--}}
{{--                                            src="{{ asset(config('appconfig.contentImagePath').$content->img_sm_path) }}"--}}
{{--                                            alt="{{ $content->img_xs_path }}" style="width: 320px;">--}}
{{--                                    </div>--}}
{{--                                </div>--}}
...
{{--                                        @endif--}}
{{--                                        <img--}}
{{--                                            src="{{ asset(config('appconfig.contentImagePath').$content->img_xs_path) }}"--}}
{{--                                            alt="{{ $content->img_xs_path }}" style="width: 120px;">--}}
{{--                                    </div>--}}
{{--                                </div>--}}
                            </div>
...
{{--                    <div class="box-body">--}}
{{--                        <div class="form-group">--}}
{{--                            <label>Normal Tag List</label>--}}
{{--                        </div>--}}
{{--                        @if($tag_letters)--}}
{{--                            @foreach($tag_letters as $tag_letter)--}}
{{--                                @php($tags =$tags = \App\Models\BnTag::select('tag_name')->where('tag_name','LIKE', $tag_letter->indexChar.'%')->where('approval', '1')->get())--}}
{{--                                @if( $loop->iteration == 1 || $loop->iteration == 5 || $loop->iteration == 9 || $loop->iteration == 13 || $loop->iteration == 17 || $loop->iteration == 21 || $loop->iteration == 25 || $loop->iteration == 29 || $loop->iteration == 33 || $loop->iteration == 37 || $loop->iteration == 41 || $loop->iteration == 45 || $loop->iteration == 49 || $loop->iteration == 53 || $loop->iteration == 57 || $loop->iteration == 61 || $loop->iteration == 65 || $loop->iteration == 69 || $loop->iteration == 73 || $loop->iteration == 77 || $loop->iteration == 81 || $loop->iteration == 85 || $loop->iteration == 89 || $loop->iteration == 93)--}}
{{--                                    <div class="col-md-12">--}}
{{--                                        @endif--}}
{{--                                        <div class="col-md-3" style="padding: 1px;">--}}
{{--                                            <div class="tag-letter" style="color: red ;padding: 0px 10px" ;>--}}
{{--                                                <div class="tag-letter">--}}
{{--                                                    <b style="display: flex; justify-content: center; font-weight: bold; font-size: 25px">{{$tag_letter->indexChar}}</b>--}}
{{--                                                    <hr style="margin: 0; border: 2px solid grey">--}}
{{--                                                </div>--}}

{{--                                                @foreach($tags as $tag)--}}
{{--                                                    <div class="tag-name">--}}
{{--                                                        <label class="tag-text btn bg-green"--}}
{{--                                                               style="display: flex; justify-content: center; margin: 4px 0px;overflow: hidden; font-size: 15px "--}}
{{--                                                               onclick="copy(this)"> {{$tag->tag_name}}</label>--}}
{{--                                                    </div>--}}
{{--                                                @endforeach--}}
{{--                                            </div>--}}
{{--                                        </div>--}}
{{--                                        @if( $loop->iteration == 4 || $loop->iteration == 8 || $loop->iteration == 12 || $loop->iteration == 16 || $loop->iteration == 20 || $loop->iteration == 24 || $loop->iteration == 28 || $loop->iteration == 32 || $loop->iteration == 36 || $loop->iteration == 40 || $loop->iteration == 44 || $loop->iteration == 48 || $loop->iteration == 52 || $loop->iteration == 56 || $loop->iteration == 60 || $loop->iteration == 64 || $loop->iteration == 68 || $loop->iteration == 72 || $loop->iteration == 76 || $loop->iteration == 80 || $loop->iteration == 84 || $loop->iteration == 88 || $loop->iteration == 92)--}}
{{--                                    </div>--}}
{{--                                @endif--}}
{{--                            @endforeach--}}
{{--                        @endif--}}
...
@section('custom-js')
    ...
    <script type="text/javascript"
            src="{{ asset('backend/adminlte/plugins/tag-it-master/js/tag-it.min.js') }}"></script>
                ...
                if (meta.filetype == 'image') {
                    ...
                    $('#upload').on('change', function () {
                        ...
                        reader.onload = function (e) {
                            ...
                            $.post('{{ url("backend/attach-photo-upload") }}', {
                                "_token": "{{ csrf_token() }}",
                                'filename': filename,
