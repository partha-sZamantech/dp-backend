            ...
            <div class="col-md-12">
                ...
                <div class="box box-info">
                    <div class="box-header with-border">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <form action="{{ route('en-contents.index') }}" method="get" class="">
                                    ...
                                    <div class="col-sm-2">
                                        <select class="form-control" name="catType" id="catType">
                                            ...
                                            @foreach($catTypes as $key => $catType)
                                                <option
                                                    value="{{ $key }}" {{ $exPartPagination['catType'] == $key ? 'selected' : '' }}>{{ $catType }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                    <div class="col-sm-2">
                                    ...
                                    <div class="col-sm-4">
                                        <input type="text" class="form-control pull-right" name="dateRange"
                                               id="dateRange" value="{{ $exPartPagination['dateRange'] }}">
                                    </div>
                                    ...
                                    <div class="col-sm-2">
                                        <div class="btn-group btn-group-justified" role="group" aria-label="...">
                                            ...
                                            <div class="btn-group" role="group">
                                                <a href="{{ url('backend/en-contents') }}" class="btn bg-aqua-gradient"><i
...
{{--                                        <span class="badge label-danger"><i class="fa fa-close"></i></span>--}}
                                ...
                                <td>
                                    ...
                                    @endif
                                    <br>
                                    <button class="badge bg-purple btn edit-content" id="{{ $content->content_id }}"
                                            data-toggle="modal" data-target="#quickUpdate">
                    ...
                    {{ $contents->appends($exPartPagination)->links('vendor.pagination.default') }}
                </div>
            </div>
        </div>
        <!-- /.row -->
                                    ...
                                    <div class="input-group">
                                        ...
                                        <select id="specialCategory" name="specialCategory" class="form-control select2"
                                            ...
                                            @foreach($specialCategories as $specialCategory)
                                                <option
                                                    value="{{ $specialCategory->cat_id }}">{{ $specialCategory->cat_name }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
