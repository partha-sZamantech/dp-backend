<style>
    ...
    .special-section {
        ...
        border-bottom: 2px solid #aba191;
    }
    ...
    .other-content {
        ...
        /*background-color: #1c4c75!important;*/
        background-color: #A06140 !important;
        height: 100%;
    }
...
<div class="special-section" style="padding-top: 0; position: relative; overflow: hidden; margin-top:20px">
    ...
    <div class="container">
        <div class="special-box special-event-section">
            <a href="https://www.dhakaprokash24.com/topic/৭ই-মার্চ" target="_blank" rel="nofollow">
                <div class="special-event-title marginTop20">
                    <div class="desktop-image">
                        <img src="{{ asset('media/common/7-March-2023.jpg') }}" alt="৭ই-মার্চ" title="এখানে ক্লিক করুন">
                    </div>
                    <div class="mobile-image">
                        <img src="{{ asset('media/common/7-March-2023__Mobile.jpg') }}" alt="৭ই-মার্চ" title="এখানে ক্লিক করুন">
                    </div>
                </div>
            </a>
