...
<div class="special-section" style="margin-top: 10px; position: relative; overflow: hidden;">
    ...
    <div class="container">
        <div class="special-box special-event-section">
            <a href="https://www.dhakaprokash24.com/topic/একুশে-ফেব্রুয়ারী" target="_blank" rel="nofollow">
                <div class="special-event-title marginTop20">
                    <div class="desktop-image">
                        <img src="{{ asset('media/common/21-February-2023.png') }}" alt="একুশে ফেব্রুয়ারী">
                    </div>
                    <div class="mobile-image">
                        <img src="{{ asset('media/common/21-February-2023_Mobile.png') }}" alt="একুশে ফেব্রুয়ারী">
                    </div>
                </div>
            </a>
