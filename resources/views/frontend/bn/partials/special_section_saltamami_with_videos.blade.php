<style>
    ...
    .special-section {
        ...
        border-bottom: 2px solid #a271c7;
    }
    ...
    .other-content {
        ...
        /*background-color: #1c4c75!important;*/
        background-color: #a271c7 !important;
        height: 100%;
    }
...
<div class="special-section" style="padding-top: 0; position: relative; overflow: hidden;">
            ...
            <a href="https://www.dhakaprokash24.com/topic/সালতামামি-২০২২" target="_blank" rel="nofollow">
                <div class="special-event-title marginTop20">
                    <div class="desktop-image">
                        <img src="{{ asset('media/common/Saltamami-2022.jpg') }}" alt="সালতামামি-২০২২" title="এখানে ক্লিক করুন">
                    </div>
                    <div class="mobile-image">
                        <img src="{{ asset('media/common/Saltamami-2022__Mobile.jpg') }}" alt="সালতামামি-২০২২">
                    </div>
                </div>
            </a>
