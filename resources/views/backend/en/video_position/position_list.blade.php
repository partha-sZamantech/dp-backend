...
<!-- Content Header (Page header) -->
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">EN Video Position List</li>
      </ol>
    </section>
            ...
            <div class="col-xs-12">
                <div class="box">
                    <div class="box-header with-border">
                      <h3 class="box-title">List of EN Video Position</h3>
                        @if(auth()->id() == 1)
                          <a href="{{ route('en-video-position.create') }}" class="btn btn-primary btn-sm pull-right"><i class="fa fa-plus"></i></a>
                        @endif
                    </div>
                        ...
                        <table class="table table-hover table-striped">
                            ...
                            @foreach($video_positions as $video_position)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('en-video-position.change', $video_position->position_id) }}" class="btn btn-xs btn-success"><i class="fa fa-edit"></i> Change Position</a>
                                        @if(auth()->id() == 1)
                                            <a href="{{ route('en-video-position.edit', $video_position->position_id) }}" class="btn btn-xs btn-warning"><i class="fa fa-edit"></i> Edit </a>
