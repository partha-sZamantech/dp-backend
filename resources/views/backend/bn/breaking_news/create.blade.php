    ...
    <div class="row">
      <div class="col-md-12">
        ...
        <div class="box box-info">
          ...
          <!-- /.box-header -->
          <!-- form start -->
          <form action="{{ route('bn-breaking-news.store') }}" method="post" class="form-horizontal col-sm-offset-1">
            {{ csrf_field() }}
            <div class="box-body">
              <div class="form-group">
                ...
                <div class="col-sm-6">
                  <input type="text" name="news_title" class="form-control" id="news_title" placeholder="News Title" required />
              ...
              <div class="form-group">
                ...
                <div class="col-sm-6">
                  <input type="text" name="news_link" class="form-control" id="news_link" placeholder="News Link">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-6">
                  <input type="text" name="expires" class="form-control" id="expires" placeholder="Expires (in hours)" required />
