                ...
                <div class="box box-info">
                    <div class="box-header with-border">
                        <div class="row" style="margin-bottom: 5px;">
                            <div class="col-sm-12">
                                <form action="{{ url('backend/bn-authors') }}" method="get">
...
{{--                                    </div>--}}
                                    ...
                                    <div class="col-sm-2">
                                        <div class="btn-group btn-group-justified" role="group" aria-label="...">
                                            ...
                                            <div class="btn-group" role="group">
                                                <a href="{{ route('bn-authors.create') }}"
                            ...
                            <tr>
                                ...
                                <td>
                                    @if(!empty($author->img_path))
                                        <img src="{{ asset(config('appconfig.authorImagePath').$author->img_path) }}"
                                             alt="{{ $author->author_name }}" class="img-thumbnail"
                                             style="width: 100px; height: 100px;">
                                    @endif
                                </td>
                                <td>
                                    <a href="{{ route('bn-authors.edit', $author->author_id) }}"
                                       class="btn btn-warning btn-xs">
                                        <i class="fa fa-pencil"></i>
                                    </a>
                                    <form action="{{ route('bn-authors.destroy', $author->author_id) }}" method="post"
