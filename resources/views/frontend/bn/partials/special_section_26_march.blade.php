<style>
    ...
    .special-section {
        ...
        background: linear-gradient(to bottom left, #FEBCBD 0%, #E4F2E5 75%) 100% no-repeat;
    ...
    .other-content {
        ...
        /*background-color: #1c4c75!important;*/
        background-color: #2C6D4F !important;
        height: 100%;
    }
...
<div class="special-section marginTop20" style="padding-top: 0; position: relative; overflow: hidden;">
    ...
    <div class="container">
        <div class="special-box special-event-section">
            <a href="https://www.dhakaprokash24.com/topic/স্বাধীনতা-দিবস" target="_blank" rel="nofollow">
                <div class="special-event-title marginTop20">
                    <div class="desktop-image">
                        <img src="{{ asset('media/common/26-March-2023.jpg') }}" alt="স্বাধীনতা-দিবস" title="এখানে ক্লিক করুন">
                    </div>
                    <div class="mobile-image">
                        <img src="{{ asset('media/common/26-March-2023__Mobile.jpg') }}" alt="স্বাধীনতা-দিবস" title="এখানে ক্লিক করুন">
                    </div>
                </div>
            </a>
                            ...
                            @if($bnSpecialEventVideos->count())
                                ...
                                @if($spEventFirstVideo->is_live == 1)
                                    @if($spEventFirstVideo->type == 1)
                                        ...
                                        <iframe width="100%" height="351"
                                                src="https://www.youtube.com/embed/{{ $spEventFirstVideo->code }}?enablejsapi=1&autoplay=1&mute=1&rel=0&showinfo=1&controls=1&loop=1"
                                                frameborder="0" allowfullscreen></iframe>
