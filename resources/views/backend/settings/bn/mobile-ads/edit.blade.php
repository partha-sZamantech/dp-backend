...
@section('content')
    ...
    <section class="content-header">
        <ol class="breadcrumb">
            ...
            <li class="active">Edit Mobile Ad Position</li>
        </ol>
    </section>
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="box box-info">
                    <!-- form start -->
                    <form action="{{ route('bn-mobile-ads.update', $ad->id) }}" method="post" class="form-horizontal" enctype="multipart/form-data">
                        {{ csrf_field() }}
                        {{ method_field('PUT') }}
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-control" id="external_link">{{ config('customdata.mobile_ad_positions')[$ad->page][$ad->position] }}</div>
