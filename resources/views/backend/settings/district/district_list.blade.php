        ...
        <div class="col-md-12">
          ...
          <div class="box box-info">
            <div class="box-header with-border">
              ...
              <a href="{{ route('districts.create') }}" class="btn btn-primary btn-sm pull-right"><i class="fa fa-plus"></i></a>
            </div>
            <!-- /.box-header -->
              ...
              <tbody>
                @foreach($districts as $no => $district)
                  <tr>
                    ...
                    <td>{{ optional($district->division)->division_name }}</td>
                    <td>
                      <a href="{{ route('districts.edit', $district->district_id) }}" class="btn btn-warning btn-xs">
                        <i class="fa fa-pencil"></i>
                      </a>
                      <form action="{{ route('districts.destroy', $district->district_id) }}" method="post" style="display: inline">
                      {{ csrf_field() }}
                      {{ method_field('DELETE') }}
