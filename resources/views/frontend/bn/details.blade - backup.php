                    ...
                    <div class="news-details">
                        ...
                        <!-- First Author Start $sURL --->
                            <div class="social-share-box d-print-none" style="position: relative">
                                ...
                                <!-- ShareThis END -->
                                <div class="socialShare_details d-flex">
{{--                                    <a href="https://www.facebook.com/sharer/sharer.php?u={{$sURL}}" class="socialIcon">--}}
{{--                                        <img width="24" height="24" src="{{ asset('/social-share/fb.png') }}" alt="facebook" title="Facebook" />--}}
{{--                                    </a>--}}
{{--                                    <a href="https://www.facebook.com/dialog/send?link={{$sURL}}&app_id=291494419107518&redirect_uri={{URL::to('/')}}" class="socialIcon">--}}
{{--                                        <img width="24" height="24" src="{{ asset('/social-share/messenger.png') }}" alt="Messenger" title="Messenger" />--}}
{{--                                    </a>--}}
                                    <a href="fb-messenger://share/?link={{$sURL}}&app_id=291494419107518" class="socialIcon">
                                        <img src="{{ asset('/social-share/messenger.png') }}" alt="Messenger" title="Messenger" />
                                    </a>
                                    <a href="https://api.whatsapp.com/send?text={{$detailsContent->content_heading}}+{{$sURL}}" class="socialIcon">
                                        <img src="{{ asset('/social-share/whatsapp.png') }}" alt="Whats App" title="Whats App" />
                                    </a>

                                    <a href="https://www.linkedin.com/shareArticle?url={{$sURL}}&title={{$detailsContent->content_heading}}" class="socialIcon">
                                        <img src="{{ asset('/social-share/linkedin.webp') }}" alt="LinkedIn" title="LinkedIn" />

                                    </a>
                                    <a href="https://twitter.com/intent/tweet?url={{$sURL}}&text={{$detailsContent->content_heading}}" class="socialIcon">
                                        <img src="{{ asset('/social-share/twitter.png') }}" alt="Twitter" title="Twitter" />
                                    </a>

                                    <a href="https://telegram.me/share/url?url={{$sURL}}&text={{$detailsContent->content_heading}}" class="socialIcon">
                                        <img src="{{ asset('/social-share/telegram.png') }}" alt="Telegram" title="Telegram" />
                                    </a>
    {{--                                <a href="#" class="socialIcon">--}}
    {{--                                    <img width="24" height="24" src="{{ asset('/social-share/copy.png') }}" alt="Copy URL" title="Copy URL" />--}}
    {{--                                </a>--}}
                                    <a  style="cursor: pointer" onclick="moreShareFunction()" class="socialIcon">
                                        <img src="{{ asset('/social-share/share.png') }}" alt="Share" title="Share" />
                                    </a>
                                    <a href="javascript:void(0)" onclick="printPageArea('printArea')" class="socialIcon">
                                        <svg height="28" width="28" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" enable-background="new 0 0 32 32" xml:space="preserve"><path fill="#595959" d="M16,0L16,0c8.837,0,16,7.163,16,16l0,0c0,8.837-7.163,16-16,16l0,0C7.163,32,0,24.837,0,16l0,0 C0,7.163,7.163,0,16,0z"></path><path fill="#FFFFFF" d="M12,20h8v4h-8V20z M21.6,22.4v-4H10.4v4H8.8c-0.212,0-0.416-0.084-0.566-0.234C8.084,22.016,8,21.812,8,21.6 v-8c0-0.212,0.084-0.416,0.234-0.566C8.384,12.884,8.588,12.8,8.8,12.8h14.4c0.212,0,0.416,0.084,0.566,0.234 C23.916,13.184,24,13.388,24,13.6v8c0,0.212-0.084,0.416-0.234,0.566c-0.15,0.15-0.353,0.234-0.566,0.234H21.6z M10.4,14.4V16h2.4 v-1.6H10.4z M12,8h8c0.212,0,0.416,0.084,0.566,0.234C20.716,8.384,20.8,8.588,20.8,8.8v2.4h-9.6V8.8 c0-0.212,0.084-0.416,0.234-0.566C11.584,8.084,11.788,8,12,8z"></path></svg>
                                    </a>
                                </div>
                                <div class="shareSocialIconss" id="moreShare" style="display: none; position: absolute; z-index: 9999">
                                    <div class="row" style="background: #fcfcfc;box-shadow: 0px 2px 6px 0px rgba(201,201,201,1); width: 380px; height: 170px;    padding: 10px; position: relative">
                                        <div class="col-md-6 col-xs-6">
                                            <a onclick="copyLink()" style="cursor: pointer" class="socialIcon" title="খবরের লিংক কপি করুন">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 37 36"><g fill="none" fill-rule="evenodd" transform="translate(.5)"><circle cx="18" cy="18" r="18" fill="#0987D5"></circle><path fill="#FFF" d="M26.063 23.25c0-.313-.11-.578-.329-.797l-2.437-2.437a1.085 1.085 0 0 0-.797-.328c-.328 0-.61.124-.844.375l.223.216c.125.121.209.205.252.252.043.047.101.121.176.223a.943.943 0 0 1 .193.621c0 .313-.11.578-.328.797a1.085 1.085 0 0 1-.797.328.943.943 0 0 1-.621-.193 2.79 2.79 0 0 1-.223-.176 7.248 7.248 0 0 1-.252-.252l-.216-.223a1.137 1.137 0 0 0-.387.856c0 .312.11.578.328.797l2.414 2.425c.21.211.477.317.797.317.312 0 .578-.102.797-.305l1.722-1.71c.22-.22.328-.481.328-.786zm-8.239-8.262c0-.312-.11-.578-.328-.797l-2.414-2.425a1.085 1.085 0 0 0-.797-.329c-.305 0-.57.106-.797.317l-1.722 1.71c-.22.22-.329.481-.329.786 0 .313.11.578.329.797l2.437 2.437c.211.211.477.317.797.317.328 0 .61-.121.844-.363a32.214 32.214 0 0 0-.223-.217 7.248 7.248 0 0 1-.252-.252 2.79 2.79 0 0 1-.176-.223.943.943 0 0 1-.193-.621c0-.313.11-.578.328-.797.219-.219.484-.328.797-.328a.943.943 0 0 1 .621.193c.102.075.176.133.223.176.047.043.13.127.252.252l.216.223c.258-.242.387-.528.387-.856zm10.488 8.262c0 .938-.332 1.73-.996 2.379l-1.722 1.71c-.649.65-1.442.974-2.38.974-.944 0-1.741-.333-2.39-.997l-2.414-2.425c-.648-.649-.973-1.442-.973-2.38 0-.96.344-1.777 1.032-2.448l-1.032-1.032c-.671.688-1.484 1.032-2.437 1.032-.938 0-1.734-.329-2.39-.985l-2.438-2.437c-.656-.657-.985-1.453-.985-2.391s.333-1.73.997-2.379l1.722-1.71c.649-.65 1.442-.973 2.38-.973.944 0 1.741.332 2.39.996l2.414 2.425c.648.649.973 1.442.973 2.38 0 .96-.344 1.777-1.032 2.448l1.032 1.032c.671-.688 1.484-1.032 2.437-1.032.938 0 1.734.329 2.39.985l2.438 2.437c.656.657.985 1.453.985 2.391z"></path></g></svg>
                                                <input id="copyLink" type="hidden" value="{{$sURL}}">
                                                <span>খবরের লিংক কপি করুন</span>
                                            </a>
                                        </div>
                                        <div class="col-md-6 col-xs-6">
{{--                                            <a href="https://www.facebook.com/dialog/send?link={{$sURL}}&app_id=291494419107518&redirect_uri={{URL::to('/')}}" class="socialIcon">--}}
...
{{--                                            </a>--}}
                                        ...
                                        <div class="col-md-6 col-xs-6">
                                            <a href="viber://pa?chatURI={{$sURL}}&text={{$detailsContent->content_heading}}" class="socialIcon">
                                                <img  src="{{ asset('/social-share/viber.png') }}" alt="Viber" title="Viber" />
                                                <span> ভাইবারে শেয়ার করুন</span>
                                            </a>
                                        </div>
                                        ...
                                        <div class="col-md-6 col-xs-6">
                                            <a href="https://api.whatsapp.com/send?text={{$detailsContent->content_heading}}+{{$sURL}}" class="socialIcon">
                                                <img  src="{{ asset('/social-share/whatsapp.png') }}" alt="Whats App" title="Whats App" />
                                                <span> হোয়াটসআপে শেয়ার করুন</span>
                                            </a>
                                        </div>
                                        <div class="col-md-6 col-xs-6">
                                            <a href="https://twitter.com/intent/tweet?url={{$sURL}}&text={{$detailsContent->content_heading}}" class="socialIcon">
                                        ...
                                        <div class="col-md-6 col-xs-6">
                                            <a href="https://telegram.me/share/url?url={{$sURL}}&text={{$detailsContent->content_heading}}" class="socialIcon">
                                                <img  src="{{ asset('/social-share/telegram.png') }}" alt="Telegram" title="Telegram" />
                                                <span>টেলিগ্রামে শেয়ার করুন</span>
                                            </a>
                                        </div>
                                        <div class="col-md-6 col-xs-6">
                                            <a href="https://www.linkedin.com/shareArticle?url={{$sURL}}&title={{$detailsContent->content_heading}}" class="socialIcon">
                                                <img src="{{ asset('/social-share/linkedin.webp') }}" alt="LinkedIn" title="LinkedIn" />
                                                <span>লিঙ্কডইনে শেয়ার করুন</span>
                                            </a>
                                        </div>
                                        <div class="col-md-6 col-xs-6">
                                            <a href="mailto:?subject={{$detailsContent->content_heading}}&body=Check out this site: {{$sURL}}" class="socialIcon">
                                                <img  src="{{ asset('/social-share/email.png') }}" alt="Email" title="Email" />
                                                <span>ইমেইল করুন</span>
                                            </a>
                                        </div>
                                        <button id="shareClose" onclick="closeShareBox()" style="position: absolute; right: 0; top: 0;background: red;border: none;color: white;">X</button>
                                    </div>
                                </div>
                            </div>
...
{{--                                        </a>--}}
                                        ...
                                        <a href="https://api.whatsapp.com/send?text={{$dcontent->content_heading}}+{{$sURL}}" class="socialIcon">
                                            <img src="{{ asset('/social-share/whatsapp.png') }}" alt="Whats App" title="Whats App" />
                                        </a>
                                        <a href="https://www.linkedin.com/shareArticle?url={{$sURL}}&title={{$dcontent->content_heading}}" class="socialIcon">
                                            <img src="{{ asset('/social-share/linkedin.webp') }}" alt="LinkedIn" title="LinkedIn" />
                                        </a>
                                        <a href="https://twitter.com/intent/tweet?url={{$sURL}}&text={{$dcontent->content_heading}}" class="socialIcon">
                                            <img src="{{ asset('/social-share/twitter.png') }}" alt="Twitter" title="Twitter" />
                                        </a>

                                        <a href="https://telegram.me/share/url?url={{$sURL}}&text={{$dcontent->content_heading}}" class="socialIcon">
                                            <img src="{{ asset('/social-share/telegram.png') }}" alt="Telegram" title="Telegram" />
                                        </a>
                                        {{--                                <a href="#" class="socialIcon">--}}
                                        {{--                                    <img width="24" height="24" src="{{ asset('/social-share/copy.png') }}" alt="Copy URL" title="Copy URL" />--}}
                                        {{--                                </a>--}}
                                        <a  style="cursor: pointer" onclick="moreShareFunction{{$key}}()" class="socialIcon">
                                            <img src="{{ asset('/social-share/share.png') }}" alt="Share" title="Share" />
                                        </a>
                                        <a href="#" onclick="printPageArea('printArea{{$key}}')" class="socialIcon">
                                            <svg height="28" width="28" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" enable-background="new 0 0 32 32" xml:space="preserve"><path fill="#595959" d="M16,0L16,0c8.837,0,16,7.163,16,16l0,0c0,8.837-7.163,16-16,16l0,0C7.163,32,0,24.837,0,16l0,0 C0,7.163,7.163,0,16,0z"></path><path fill="#FFFFFF" d="M12,20h8v4h-8V20z M21.6,22.4v-4H10.4v4H8.8c-0.212,0-0.416-0.084-0.566-0.234C8.084,22.016,8,21.812,8,21.6 v-8c0-0.212,0.084-0.416,0.234-0.566C8.384,12.884,8.588,12.8,8.8,12.8h14.4c0.212,0,0.416,0.084,0.566,0.234 C23.916,13.184,24,13.388,24,13.6v8c0,0.212-0.084,0.416-0.234,0.566c-0.15,0.15-0.353,0.234-0.566,0.234H21.6z M10.4,14.4V16h2.4 v-1.6H10.4z M12,8h8c0.212,0,0.416,0.084,0.566,0.234C20.716,8.384,20.8,8.588,20.8,8.8v2.4h-9.6V8.8 c0-0.212,0.084-0.416,0.234-0.566C11.584,8.084,11.788,8,12,8z"></path></svg>
                                        </a>
                                    </div>
                                    <div class="shareSocialIconss" id="moreShare{{$key}}" style="display: none; position: absolute; z-index: 9999">
                                        <div class="row" style="background: #fcfcfc;box-shadow: 0px 2px 6px 0px rgba(201,201,201,1); width: 360px; height: 170px;    padding: 10px; position: relative">
                                            <div class="col-md-6 col-xs-6">
                                                <a onclick="copyLink{{$key}}()" style="cursor: pointer" class="socialIcon" title="খবরের লিংক কপি করুন">
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 37 36"><g fill="none" fill-rule="evenodd" transform="translate(.5)"><circle cx="18" cy="18" r="18" fill="#0987D5"></circle><path fill="#FFF" d="M26.063 23.25c0-.313-.11-.578-.329-.797l-2.437-2.437a1.085 1.085 0 0 0-.797-.328c-.328 0-.61.124-.844.375l.223.216c.125.121.209.205.252.252.043.047.101.121.176.223a.943.943 0 0 1 .193.621c0 .313-.11.578-.328.797a1.085 1.085 0 0 1-.797.328.943.943 0 0 1-.621-.193 2.79 2.79 0 0 1-.223-.176 7.248 7.248 0 0 1-.252-.252l-.216-.223a1.137 1.137 0 0 0-.387.856c0 .312.11.578.328.797l2.414 2.425c.21.211.477.317.797.317.312 0 .578-.102.797-.305l1.722-1.71c.22-.22.328-.481.328-.786zm-8.239-8.262c0-.312-.11-.578-.328-.797l-2.414-2.425a1.085 1.085 0 0 0-.797-.329c-.305 0-.57.106-.797.317l-1.722 1.71c-.22.22-.329.481-.329.786 0 .313.11.578.329.797l2.437 2.437c.211.211.477.317.797.317.328 0 .61-.121.844-.363a32.214 32.214 0 0 0-.223-.217 7.248 7.248 0 0 1-.252-.252 2.79 2.79 0 0 1-.176-.223.943.943 0 0 1-.193-.621c0-.313.11-.578.328-.797.219-.219.484-.328.797-.328a.943.943 0 0 1 .621.193c.102.075.176.133.223.176.047.043.13.127.252.252l.216.223c.258-.242.387-.528.387-.856zm10.488 8.262c0 .938-.332 1.73-.996 2.379l-1.722 1.71c-.649.65-1.442.974-2.38.974-.944 0-1.741-.333-2.39-.997l-2.414-2.425c-.648-.649-.973-1.442-.973-2.38 0-.96.344-1.777 1.032-2.448l-1.032-1.032c-.671.688-1.484 1.032-2.437 1.032-.938 0-1.734-.329-2.39-.985l-2.438-2.437c-.656-.657-.985-1.453-.985-2.391s.333-1.73.997-2.379l1.722-1.71c.649-.65 1.442-.973 2.38-.973.944 0 1.741.332 2.39.996l2.414 2.425c.648.649.973 1.442.973 2.38 0 .96-.344 1.777-1.032 2.448l1.032 1.032c.671-.688 1.484-1.032 2.437-1.032.938 0 1.734.329 2.39.985l2.438 2.437c.656.657.985 1.453.985 2.391z"></path></g></svg>
                                                    <input id="copyLink{{$key}}" type="hidden" value="{{$sURL}}">
                                                    <span>খবরের লিংক কপি করুন</span>
                                                </a>
                                                <script>
                                                    function copyLink{{$key}}(){
                                                        var link = document.getElementById('copyLink{{$key}}').value
...
{{--                                                </a>--}}
                                            ...
                                            <div class="col-md-6 col-xs-6">
                                                <a href="viber://pa?chatURI={{$sURL}}&text={{$dcontent->content_heading}}" class="socialIcon">
                                                    <img   style="width: 24px; height: 24px" src="{{ asset('/social-share/viber.png') }}" alt="Viber" title="Viber" />
                                                    <span>ভাইবারে শেয়ার করুন</span>
                                                </a>
                                            </div>
                                            <div class="col-md-6 col-xs-6">
                                            ...
                                            <div class="col-md-6 col-xs-6">
                                                <a href="mailto:?subject={{$dcontent->content_heading}}&body=Check out this site: {{$sURL}}" class="socialIcon">
                                                    <img  src="{{ asset('/social-share/email.png') }}" alt="Email" title="Email" />
                                                    <span>ইমেইল করুন</span>
                                                </a>
                                            </div>
                                            <button id="shareClose" onclick="closeShareBox{{$key}}()" style="position: absolute; right: 0; top: 0;background: red;border: none;color: white;">X</button>
                                        </div>
                                    </div>
                                </div>
                                <script>
                                    function moreShareFunction{{$key}}(){
                                        var x = document.getElementById("moreShare{{$key}}");
