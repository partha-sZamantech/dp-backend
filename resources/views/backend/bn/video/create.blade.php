    ...
    <div class="row">
      <div class="col-md-12">
        ...
        <div class="box box-info">
          ...
          <!-- /.box-header -->
          <!-- form start -->
          <form action="{{ route('bn-videos.store') }}" method="post" enctype="multipart/form-data" class="form-horizontal">
            {{ csrf_field() }}
            <div class="box-body">
                    ...
                    <div class="col-sm-6">
                        <select name="category" id="category" class="form-control" required>
                            @foreach($categories as $category)
                                <option value="{{ $category->id }}"{{ old('category') == $category->id ? ' selected' : '' }}>{{ $category->name_bn }}</option>
                            @endforeach
                        </select>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-6">
                        <select name="target" id="target" class="form-control" required>
                            <option value="1"{{ old('target') == 1 ? ' selected' : '' }}>Same Site</option>
                            <option value="2"{{ old('target') == 2 ? ' selected' : '' }}>New Window</option>
                        </select>
                    </div>
                </div>
                <div class="form-group">
