...
@php
    $footerStickyAd = isMobile() ? Cache::get('mobileCommonAdsCacheKey')->where('position', 3)->first() : Illuminate\Support\Facades\Cache::get('commonAdsCacheKey')->where('position', 3)->first();
