        ...
        <div class="col-md-12">
          ...
          <div class="box box-info">
            <div class="box-header with-border">
              ...
              <a href="{{ route('bn-subcategories.create') }}" class="btn btn-primary btn-sm pull-right"><i class="fa fa-plus"></i></a>
            </div>
            <!-- /.box-header -->
              ...
              <tbody>
                @foreach($subcategories as $no => $subcategory)
                  <tr>
                    ...
                    <td>
                      <a href="{{ route('bn-subcategories.edit', $subcategory->subcat_id) }}" class="btn btn-warning btn-xs">
                        <i class="fa fa-pencil"></i>
                      </a>
                      <form action="{{ route('bn-subcategories.destroy', $subcategory->subcat_id) }}" method="post" style="display: inline">
                      {{ csrf_field() }}
                      {{ method_field('DELETE') }}
