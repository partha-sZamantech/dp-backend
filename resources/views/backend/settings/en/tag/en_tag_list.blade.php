...
@section('content')
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">En Tag List</li>
        </ol>
    </section>
                ...
                <div class="box box-info">
                    <div class="box-header with-border">
                        <div class="row" style="margin-bottom: 5px;">
                            <div class="col-sm-12">
                                <form action="{{ url('backend/en-tags') }}" method="get">
                                    <div class="col-sm-5">
                    ...
                    <table class="table table-bordered">
                        ...
                        @foreach($tags as $tag)
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route('en-tags.edit', $tag->tag_id) }}" class="btn btn-warning btn-xs">
                                        <i class="fa fa-pencil"></i>
                                    </a>
                                    <form action="{{ route('en-tags.destroy', $tag->tag_id) }}" method="post" style="display: inline">
                                        {{ csrf_field() }}
                                        {{ method_field('DELETE') }}
