<style>
    ...
    .other-content {
        ...
        /*background-color: #1c4c75!important;*/
        background-color: #CCB49A !important;
        height: 100%;
    }
...
<div class="special-section" style="padding-top: 0; position: relative; overflow: hidden;">
    ...
    <div class="container">
        <div class="special-box special-event-section">
            <a href="https://www.dhakaprokash24.com/topic/জাতীয়-শিশু-দিবস" target="_blank" rel="nofollow">
                <div class="special-event-title marginTop20">
                    <div class="desktop-image">
                        <img src="{{ asset('media/common/17-March-2023.png') }}" alt="জাতীয়-শিশু-দিবস" title="এখানে ক্লিক করুন">
                    </div>
                    <div class="mobile-image">
                        <img src="{{ asset('media/common/17-March-2023_Mobile.png') }}" alt="জাতীয়-শিশু-দিবস" title="এখানে ক্লিক করুন">
                    </div>
                </div>
            </a>
