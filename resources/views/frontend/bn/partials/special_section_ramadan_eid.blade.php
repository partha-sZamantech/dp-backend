<style>
    ...
    .special-section {
        ...
        border-bottom: 2px solid #c2998f;
    }
...
<div class="special-section marginTop10" style="padding-top: 0; position: relative; overflow: hidden;">
    ...
    <div class="container">
        <div class="special-box special-event-section">
            <a href="https://www.dhakaprokash24.com/topic/ঈদুল-ফিতর-২০২৩" target="_blank" rel="nofollow">
                <div class="special-event-title marginTop20">
                    <div class="desktop-image">
                        <img src="{{ asset('media/common/Eid-Special-Banner.png') }}" alt="ঈদুল ফিতর ২০২৩" title="ঈদুল ফিতর ২০২৩">
                    </div>
                    <div class="mobile-image">
                        <img src="{{ asset('media/common/Eid-Special-Banner__Mobile.png') }}" alt="ঈদুল ফিতর ২০২৩">
                    </div>
                </div>
            </a>
