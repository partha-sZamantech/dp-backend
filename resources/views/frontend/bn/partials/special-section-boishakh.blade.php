<style>
    ...
    .special-section {
        ...
        border-bottom: 2px solid #ed9464;
    }
    ...
    .other-content {
        ...
        /*background-color: #1c4c75!important;*/
        background-color: #DD0008 !important;
        height: 100%;
    }
...
<div class="special-section marginTop10" style="padding-top: 0; position: relative; overflow: hidden;">
    ...
    <div class="container">
        <div class="special-box special-event-section">
            <a href="https://www.dhakaprokash24.com/topic/বাংলা-নববর্ষ-১৪৩০" target="_blank" rel="nofollow">
                <div class="special-event-title marginTop20">
                    <div class="desktop-image">
                        <img src="{{ asset('media/common/Boishakh.jpg') }}" alt="বাংলা নববর্ষ ১৪৩০" title="বাংলা নববর্ষ ১৪৩০">
                    </div>
                    <div class="mobile-image">
                        <img src="{{ asset('media/common/Boishakh_Mobile.jpg') }}" alt="বাংলা নববর্ষ ১৪৩০">
                    </div>
                </div>
            </a>
