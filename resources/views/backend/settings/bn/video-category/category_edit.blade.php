    ...
    <div class="row">
      <div class="col-md-12">
        ...
        <div class="box box-info">
          <!-- form start -->
          <form action="{{ route('bn-video-categories.update', $category->id) }}" method="post" class="form-horizontal col-sm-offset-1">
            {{ csrf_field() }}
            {{ method_field('PUT') }}
            <div class="box-body">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-6">
                  <input type="text" name="categoryNameBn" class="form-control" id="categoryNameBn" value="{{ $category->name_bn }}">
