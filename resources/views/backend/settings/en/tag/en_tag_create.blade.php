        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="box box-info">
                    <!-- form start -->
                    <form action="{{ route('en-tags.store') }}" method="post" enctype="multipart/form-data" class="form-horizontal col-sm-offset-1">
                        {{ csrf_field() }}
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                <label for="tagName" class="col-sm-2 control-label">Tag name
                            ...
                            <div class="form-group">
                                <label for="tagSlug" class="col-sm-2 control-label">Tag slug
                                    <span class="required">*</span></label>
                                <div class="col-sm-8">
                                    <input type="text" name="tagSlug" class="form-control" id="tagSlug" placeholder="Tag slug">
                                    @if($errors->has('tagSlug'))
                                        <span class="text-danger">{{ $errors->first('tagSlug') }}</span>
                                    @endif
                                </div>
                            </div>
