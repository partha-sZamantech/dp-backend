...
@section('content')
    ...
    <section class="content-header">
        <ol class="breadcrumb">
            ...
            <li class="active">Magazine Add</li>
        </ol>
    </section>
            ...
            <div class="col-md-12">
                ...
                <div class="box box-info">
                    <div class="box-header with-border">
                        <h3 class="box-title">Magazine Insert</h3>
                    </div>
                    <!-- /.box-header -->
                    <!-- form start -->
                    <form action="{{ route('magazines.store') }}" method="post"
                        ...
                        <div class="box-body">
                            <div class="form-group">
                                ...
                                <div class="col-sm-7">
                                    <input type="text" name="magazine_name" class="form-control" id="magazine_name"
                                           placeholder="Magazine name" value="{{ old('magazine_name') }}">
