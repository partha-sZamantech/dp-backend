...
@section('content')
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">En Category List</li>
        </ol>
    </section>
            ...
            <div class="col-md-12">
                ...
                <div class="box box-info">
                    <div class="box-header with-border">
                        ...
                        <a href="{{ route('en-categories.create') }}" class="btn btn-primary btn-sm pull-right"><i class="fa fa-plus"></i></a>
                    </div>
                    <!-- /.box-header -->
                    <table class="table table-bordered">
                        ...
                        @foreach($categories as $no => $category)
                            <tr>
                                ...
                                <td>
                                    Top Menu:
                                    <span class="label label-{{ $category->top_menu == 1 ? 'success' : 'danger' }}">{{ $category->top_menu == 1 ? 'Yes' : 'No' }}</span><br>
                                    Footer Menu:
                                    <span class="label label-{{ $category->footer_menu == 1 ? 'success' : 'danger' }}">{{ $category->footer_menu == 1 ? 'Yes' : 'No' }}</span>
                                </td>
                                ...
                                <td>
                                    <a href="{{ route('en-categories.edit', $category->cat_id) }}" class="btn btn-warning btn-xs">
                                        <i class="fa fa-pencil"></i>
                                    </a>
                                    <form action="{{ route('en-categories.destroy', $category->cat_id) }}" method="post" style="display: inline">
                                        {{ csrf_field() }}
                                        {{ method_field('DELETE') }}
