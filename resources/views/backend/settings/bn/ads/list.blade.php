...
@section('content')
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">Ads Position List</li>
        </ol>
    </section>
            ...
            <div class="col-md-12">
                ...
                <div class="box box-info">
                    <div class="box-header with-border">
                        ...
                        @if(auth()->id() == 1)
                        <a href="{{ route('bn-ads.create') }}" class="btn btn-primary btn-sm pull-right"><i class="fa fa-plus"></i></a>
                        @endif
                    </div>
                    <!-- /.box-header -->
                    <table class="table table-bordered">
                        ...
                        @foreach($ads as $ad)
                            <tr>
                                ...
                                <td>
                                    {{config('customdata.ad_positions')[$ad->page][$ad->position] }}
                                </td>
                                <td>
                                ...
                                <td>
                                    <a href="{{ route('bn-ads.edit', $ad->id) }}" class="btn btn-warning btn-xs">
