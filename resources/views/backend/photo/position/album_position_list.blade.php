            ...
            <div class="col-xs-12">
                <div class="box">
                    <div class="box-header with-border">
                        ...
                        {{--                        <a href="{{ route('photo-album-positions.create') }}" class="btn btn-primary btn-sm pull-right"><i--}}
                        ...
                        <table class="table table-hover table-striped">
                            ...
                            @foreach($content_positions as $content_position)
                                <tr>
                                    ...
                                    <td>{{ $content_position->special_cat_id ?? $content_position->cat_id }}</td>
                                    <td>{{ $content_position->content_ids }}</td>
                                    <td>
                                        <a href="{{ route('photo-album-positions.getChangePosition', $content_position->position_id) }}"
                                           class="btn btn-xs btn-success"><i class="fa fa-edit"></i> Change Position</a>

                                        @if(auth()->user()->role == 1)
                                            <a href="{{ route('photo-album-positions.edit', $content_position->position_id) }}"
