            ...
            <div class="col-md-12">
                ...
                <div class="box box-info">
                    <div class="box-header with-border">
                        ...
                        <a href="{{ route('bn-breaking-news.create') }}" class="btn btn-primary btn-sm pull-right"><i
                                class="fa fa-plus"></i></a>
                        <a href="{{ route('bn-breaking-news.getSettingPosition') }}"
                    ...
                    <table class="table table-bordered">
                        ...
                        @foreach($breakingNews as $key => $news)
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route('bn-breaking-news.edit', $news->id) }}"
                                       class="btn btn-warning btn-xs">
                                        <i class="fa fa-pencil"></i>
                                    </a>
                                    <form action="{{ route('bn-breaking-news.destroy', $news->id) }}" method="post"
